...
public class AccountClientTests {
	...
	public void addAndDeleteBeneficiary() {
		...
		ResponseEntity<Beneficiary> missingBeneficiary = restTemplate.getForEntity(newBeneficiaryLocation, Beneficiary.class);
		assertEquals(HttpStatus.NOT_FOUND, missingBeneficiary.getStatusCode());
	}
