...
//		String number = String.format("12345%4d", random.nextInt(10000));
		String number = "123123123"; // Change for TO-DO-17
	...
	public void addAndDeleteBeneficiary() {
		...
		URI newBeneficiaryUri = restTemplate.postForLocation(BASE_URL + "/accounts/1/beneficiaries", "David");
		assertNotNull(newBeneficiaryUri);
